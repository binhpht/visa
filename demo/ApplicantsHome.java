...
/**
 * Home object for domain model class Applicants.
 * @see .Applicants
 * @author Hibernate Tools
 */
public class ApplicantsHome {

	private static final Log log = LogFactory.getLog(ApplicantsHome.class);
	...
	public void persist(Applicants transientInstance) {
		log.debug("persisting Applicants instance");
		try {
	...
	public Applicants merge(Applicants detachedInstance) {
		...
		try {
			Applicants result = (Applicants) sessionFactory.getCurrentSession()
	...
	public Applicants findById(java.lang.Integer id) {
		...
		try {
			Applicants instance = (Applicants) sessionFactory
					.getCurrentSession().get("Applicants", id);
			if (instance == null) {
	...
	public List findByExample(Applicants instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Applicants").add(Example.create(instance))
					.list();
